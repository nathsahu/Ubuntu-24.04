...
# Isse user jab 'ubuntu' likhega toh login ho jayega
mkdir -p ~/ubuntu-lts
...
# Ubuntu ke andar login ho kar setup_ubuntu.sh ko run karna
# Maine yahan tumhara GitHub ka raw link daal diya hai
proot-distro login ubuntu-24.04 -- sh -c "apt update && apt install wget -y && wget https://raw.githubusercontent.com/nathsahu/Ubuntu-24.04/main/setup_ubuntu.sh && chmod +x setup_ubuntu.sh && ./setup_ubuntu.sh"
